...
本章節已隨附現成的初學者作業範本 [`01-nano4-ssh-and-2fa/scripts/sample_first_job.slurm`](https://github.com/gemini960114/Nano4-Docs/blob/main/01-nano4-ssh-and-2fa/scripts/sample_first_job.slurm)。

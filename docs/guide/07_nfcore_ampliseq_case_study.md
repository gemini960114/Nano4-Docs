...
人工版完成後才使用 [`prompts/ai_reproduce.md`](https://github.com/gemini960114/Nano4-Docs/blob/main/07-nfcore-ampliseq-case-study/prompts/ai_reproduce.md)。這份 prompt 會要求 AI 使用 `nfcore-ampliseq-nano4` 等 Skills；若尚未在第 06 章安裝，請先執行：
...
👈 **回到**：[課程總綱與學習地圖](./00_course_syllabus)
